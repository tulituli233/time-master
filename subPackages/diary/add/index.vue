    ...
    <view>
        <view class="editor_toolbox">
            <view style="display: flex;">
                ...
                <i class="iconfont icon-line" data-method="insertHtml" data-param="<hr style='margin:10px 0'/>"
                    @tap="edit" />
        ...
        <view>
            <view class="memo-title">
                <input class="memo-title-input" type="text" placeholder="标题" v-model="diaryTitle" />
            </view>
